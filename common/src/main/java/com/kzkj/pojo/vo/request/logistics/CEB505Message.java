...
//XML文件中的根标识  
@XmlRootElement(name="CEB505Message")  
//控制JAXB 绑定类中属性和字段的排序  
@XmlType(propOrder = {   
     "Logistics",   
     "BaseTransfer",   
...
@Data
public class CEB505Message implements Serializable{
	...
	@XmlElement
	private List<com.kzkj.pojo.vo.request.logistics.Logistics> Logistics;
