...
public class CustomTransInfo implements Serializable{
	...
	private com.kzkj.pojo.vo.request.customs.ReceiverIds ReceiverIds;
	...
	public com.kzkj.pojo.vo.request.customs.ReceiverIds getReceiverIds() {
		return ReceiverIds;
	}

	public void setReceiverIds(com.kzkj.pojo.vo.request.customs.ReceiverIds receiverIds) {
